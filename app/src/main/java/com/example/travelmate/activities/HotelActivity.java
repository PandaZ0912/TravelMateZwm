...
public class HotelActivity extends AppCompatActivity {
    ...
    private List<HotelItem> getHotels(String city) {
        ...
        switch (city) {
            case "北京":
                hotels.add(new HotelItem("北京丽都酒店", "五星级豪华酒店", R.drawable.fourseasons_beijing, 4.7, 1200, "北京市朝阳区丽都大厦", "五星级"));
                hotels.add(new HotelItem("北京朝阳酒店", "四星级舒适酒店", R.drawable.fourseasons_beijing, 4.3, 800, "北京市朝阳区建国门外大街", "四星级"));
                break;
            case "上海":
                hotels.add(new HotelItem("上海外滩酒店", "享有外滩美景", R.drawable.fourseasons_beijing, 4.9, 1500, "上海市黄浦区外滩", "五星级"));
                hotels.add(new HotelItem("上海浦东机场酒店", "便捷的机场酒店", R.drawable.fourseasons_beijing, 4.2, 600, "上海市浦东新区机场", "三星级"));
                break;
            case "广州":
                hotels.add(new HotelItem("广州塔酒店", "高端的城市地标酒店", R.drawable.fourseasons_beijing, 4.6, 1000, "广州市天汇大街", "五星级"));
                hotels.add(new HotelItem("广州白云酒店", "城市便捷酒店", R.drawable.fourseasons_beijing, 4.1, 500, "广州市白云山路", "三星级"));
                break;
            case "深圳":
                hotels.add(new HotelItem("深圳湾大酒店", "豪华海景酒店", R.drawable.fourseasons_beijing, 4.8, 1800, "深圳市南山区滨海大道", "五星级"));
                hotels.add(new HotelItem("深圳国际机场酒店", "便捷机场酒店", R.drawable.fourseasons_beijing, 4.4, 700, "深圳市宝安区机场路", "四星级"));
                break;
            default:
